...
class LaneDetector:
    ...
    def __init__(self):
        ...
        self.row_anchor = []
        self.cfg = None
        self.cls_num_per_lane = 56  #[for tusimple dataset] (27 for curvelaneown)
    ...
    def process_image(self, imgs):
        ...
        # cv2.resize(imgs, (1280,720),interpolation=cv2.INTER_AREA)
        ...
        # Resize the lane markers image for publishing to the required output size
        lane_markers_resized = cv2.resize(lane_markers, (640, 480), interpolation=cv2.INTER_AREA)
